...
(define (convert10help number base)
  (if (equal? number 0) '()
      (cons (modulo number base) (convert10help (quotient number base) base))))

(define (convert10 number base)
  (reverse (convert10help number base)))
...
(define (base10help oldbase numlist cur_tot)
  (if (equal? numlist '()) cur_tot
      (base10help oldbase (cdr numlist) (+ (* cur_tot oldbase) (car numlist)))))

(define (base10 oldbase numlist)
  (base10help oldbase numlist 0))
