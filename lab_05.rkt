...
(define (reverse-help inlist outlist)
  (if (null? inlist) outlist (reverse-help (cdr inlist) (cons (car inlist) outlist))))
...
(define (max-help numbers running-max)
  (if (null? numbers) running-max
      (if (> (car numbers) running-max) (max-help (cdr numbers) (car numbers)) (max-help (cdr numbers) running-max) ))) 
...
(define (min-help numbers running-min)
  (if (null? numbers) running-min
      (if (< (car numbers) running-min) (min-help (cdr numbers) (car numbers)) (min-help (cdr numbers) running-min) )))
...
(define (sum-help numbers running-total)
  (if (null? numbers) running-total (+ (car numbers) (sum-help (cdr numbers) running-total))))
...
(define (reduce-help f init list)
  (if (null? list) init (reduce-help f (f (car list) init) (cdr list))))
